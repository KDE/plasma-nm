...
$XGETTEXT rc.cpp `find applet -name '*.cpp'` `find declarative-plugins -name '*.cpp'` `find lib -name '*.cpp'` `find settings/details -name '*.cpp'` -o $podir/plasma_applet_org.kde.plasma-nm.pot
