...
#ifndef PLASMA_NM_IPV4_SETTING_H
#define PLASMA_NM_IPV4_SETTING_H
...
class Ipv4Setting : public Setting
{
    Q_OBJECT
public:
    explicit Ipv4Setting(const NetworkManager::Setting::Ptr &setting = NetworkManager::Ipv4Setting::Ptr(), QObject *parent = nullptr);
    virtual ~Ipv4Setting();
...
#endif // PLASMA_NM_IPV4_SETTING_H
